...
public class HelloWorldWorkflowImpl implements HelloWorldWorkflow {
    ...
    // ActivityStubs enable calls to Activities as if they are local methods,
    ...
    public String getGreeting(String name) {
        ...
        // If there were other Activity methods they would be
        // orchestrated here or from within other Activities.
